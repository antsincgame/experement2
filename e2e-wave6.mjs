...
const TEST_PROMPTS = [
  // Wave 6 — health & lifestyle
  "Sleep tracker with bedtime reminders",
  "Meditation timer with breathing exercises",
  "Calorie counter with meal log",
...
const main = async () => {
  ...
  console.log(`\n${"=".repeat(60)}`);
  console.log(`WAVE 6 RESULTS: ${passed} PASS / ${failed} FAIL / ${TEST_PROMPTS.length} TOTAL`);
  console.log(`${"=".repeat(60)}`);
