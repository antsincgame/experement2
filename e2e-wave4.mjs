...
const TEST_PROMPTS = [
  // Wave 4 — productivity & finance
  "Budget tracker with income and expense categories",
  "Pomodoro timer with task list",
  "BMI calculator with health tips",
  "Random password generator with strength meter",
  "Grocery list app with quantity and checkboxes",
  "Flashcard quiz app with flip animation",
  "Unit converter for length weight and temperature",
  "Simple notes app with search",
  "Event countdown with multiple events",
...
const main = async () => {
  ...
  console.log(`\n${"=".repeat(60)}`);
  console.log(`WAVE 4 RESULTS: ${passed} PASS / ${failed} FAIL / ${TEST_PROMPTS.length} TOTAL`);
  console.log(`${"=".repeat(60)}`);
