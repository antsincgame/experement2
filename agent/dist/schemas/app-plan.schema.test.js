...
describe("FileInPlanSchema", () => {
    ...
    it("rejects empty path", () => {
        expect(() => FileInPlanSchema.parse({ ...validFile, path: "" })).toThrow();
    });
});
describe("AppPlanSchema", () => {
    ...
    it("rejects empty name", () => {
        expect(() => AppPlanSchema.parse({ ...minimalPlan, name: "" })).toThrow();
    });
    it("rejects plan with empty files array", () => {
        expect(() => AppPlanSchema.parse({ ...minimalPlan, files: [] })).toThrow();
    });
...
//# sourceMappingURL=app-plan.schema.test.js.map