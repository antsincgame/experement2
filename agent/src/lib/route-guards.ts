// Protects destructive HTTP routes with explicit confirmation headers and an env kill switch.
...
const DANGEROUS_ROUTES_ENABLED =
  process.env.ALLOW_DANGEROUS_PROJECT_OPERATIONS !== "false";

const readConfirmationHeader = (req: Request): string | null => {
...
export const requireDangerousAction = (
  req: Request,
  res: Response,
