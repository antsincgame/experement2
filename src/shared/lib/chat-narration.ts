  ...
  switch (status) {
    case "planning":
      return [
        ...
        "",
        "You'll get a readable blueprint card here — routes, screens, components, dependencies. When it feels complete, I lock it and nothing moves underneath us during codegen.",
        "",
...
export const formatPlanLockedNarration = (
  ...
  [
    ...
    "",
    "The blueprint card above is your readable map; the canonical JSON is in `.appfactory/blueprint.json`. Next I'll scaffold the Expo shell, then write each file against that map.",
    "",
