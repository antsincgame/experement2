...
const TEST_PROMPTS = [
  ...
  "Simon says memory game with colors",
  "Dice roller with multiple dice types",
  "Rock paper scissors game with score",
  "Word scramble game with hints",
  "Math quiz with timer and leaderboard",
  "Trivia app with multiple choice questions",
  "Snake game with score display",
  "Memory card matching game",
  "Typing speed test with WPM counter",
];
...
const main = async () => {
  ...
  console.log(`\n${"=".repeat(60)}`);
  console.log(`WAVE 5 RESULTS: ${passed} PASS / ${failed} FAIL / ${TEST_PROMPTS.length} TOTAL`);
  console.log(`${"=".repeat(60)}`);
